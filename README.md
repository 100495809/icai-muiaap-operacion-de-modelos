...
| [S5](semana5/) | Streamlit básico: widgets, formularios, reruns, gateway y presentación. | Primera interfaz web del modelo con formulario, predicción visible y error comprensible. | Presenta el bundle de S4 a una persona no técnica. |
