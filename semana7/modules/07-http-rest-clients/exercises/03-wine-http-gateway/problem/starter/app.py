...
from model_ui.http_gateway import HttpInferenceGateway  # noqa: F401 - pista S7.5
...
def build_gateway(
    ...
    # TODO S7.5: si api_url contiene una URL, prioriza
    # HttpInferenceGateway(api_url) sobre los gateways locales de S6.
    if not bundle_value:
        return DemoGateway()
    try:
